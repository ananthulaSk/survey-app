...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  // Version Handshake
  static const String EXPECTED_BACKEND_VERSION = "v19.31";
  String _backendVersion = "Fetching...";
  final String _appVersionDisplay = "v19.31 (Isolation Fix)";
  ...
  Future<void> _checkVersion() async {
    ...
    if (mounted) {
      ...
      // EXPECTATION Check
      if (_backendVersion != EXPECTED_BACKEND_VERSION) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              "Warning: Backend is $_backendVersion (Expected $EXPECTED_BACKEND_VERSION). Refresh Needed.",
            ),
